#############################################################
#' Mean ellipsoid rotation using quarternion average
#' 
#' @param x list of ellipsoids
#' @param ... ignored
#' 
#' @details Average in the quarternion space
#' 
#' @export
...
#' Mean of ellipses
#' 
#' 2D ellipsoid averaging.
#' 
#' @param x a list of ellipses (2d)
#' @param weight weighted average weights
#' 
#' @export
